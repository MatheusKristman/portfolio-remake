...
function ContactPage() {
  ...
  return (
    <>
      <section className="w-full px-6 sm:px-16 mt-24 mb-12 lg:container lg:mx-auto">
        ...
        <div className="w-full flex flex-col gap-24">
          ...
          <div className="w-full flex flex-col gap-6 lg:max-w-lg lg:mx-auto">
            <p className="text-base font-light text-primary text-center opacity-70">
              Além do formulário abaixo, você também pode entrar em contato
              comigo através do meu e-mail ou telefone.
            </p>
